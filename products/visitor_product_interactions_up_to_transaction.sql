WITH q_transaction_v01 AS (SELECT
        *
      FROM
        `qubit-client-37040.halfords_uk_prod__v2__v2.livetap_transaction`
      WHERE
  ...
  ,  q_product_v01 AS (SELECT
        ...
        FROM
          `qubit-client-37040.halfords_uk_prod__v2__v2.livetap_product` v
        LEFT JOIN
...
FROM `qubit-client-37040.halfords_uk_prod__v2__v2.livetap_view`  AS q_view_v01
