...
LEFT JOIN `qubit-client-CLIENTPROJECTNUM.CLIENTNAME____v2.livetap_attribution`  AS q_attribution_v01 ON (q_attribution_v01.context_id = q_view_v01.context_id
