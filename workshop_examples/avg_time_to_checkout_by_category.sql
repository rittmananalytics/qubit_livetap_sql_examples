...
select first_page_subtype, avg(seconds_to_purchase)/60 as mins_to_checkout
from checkout_funnel_sessions
where first_page_subtype not like 'Halfords%'
group by 1
